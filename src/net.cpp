...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Incoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"incointools.com", "dnsseed.incointools.com"},
    {"incoinpool.org", "dnsseed.incoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"incointools.com", "testnet-seed.incointools.com"},
